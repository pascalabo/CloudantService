# Generated Implementation Artifact Skeleton for org_example_www_tosca_nodetypes_OpenWhiskPlatform__org_opentosca_interfaces_lifecycle

* Interface Name: org_example_www_tosca_nodetypes_OpenWhiskPlatform__org_opentosca_interfaces_lifecycle
* Namespace: http://nodetypeimplementations.tosca.www.example.org/
* Java Package: org.example.www.tosca.nodetypeimplementations
* URL: http://192.168.0.19:8080/winery/artifacttemplates/http%253A%252F%252Fwww.example.org%252Ftosca%252Fartifacttemplates/OpenWhiskPlatform--http---opentosca-org-interfaces-lifecycle-IA/files../
